...
<div class="blockmidleft">
    ...
    <div class="placessmall">
        ...
        <a href="/[[if not(url)]]{education_news_url}[[else]]{url}[[endif]]/{item.redir}/">{item.name}</a>
        [[endfor]]
    </div>
    <div class="events-all"><a href="/[[if not(url)]]{education_news_url}[[else]]{url}[[endif]]/">Все новости образования</a></div>
