...
<div class="blockmidleft sosedbackground">
    ...
    <div>
        ...
        [[if loop.first == 1]]
        <div class="left-info">
            <a href="/[[if not(url)]]{news_url}[[else]]{url}[[endif]]/{new_item.cat_redir}/{new_item.redir_new}/"><img alt="img1" src="/images/sitemodul_image/business/{new_item.id_new}/mini{new_item.picture}"/></a>
            <div class="left-text">
