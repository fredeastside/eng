<?php
        ...
        $news_obj = new fmakeBusinessNews();
        ...
        if($request -> getEscape('url')){
            ...
            if(is_string($item)){
                ...
                $modul->template = "business_news/item.tpl"; //exit;
                ...
                //printAr($item);
                $globalTemplateParam->set('item', $item);
                $modul->template = "business_news/category.tpl"; //exit;
            }
        }else{
	...
	$modul->template = "business_news/all_news.tpl";
        }
?>
