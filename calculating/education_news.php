<?php
        ...
        $news_obj = new fmakeEducationNews();
        ...
        if($request -> getEscape('url')){
            ...
            if(is_string($item)){
                ...
                $modul->template = "education_news/item.tpl"; //exit;
                ...
                //printAr($item);
                $globalTemplateParam->set('item', $item);
                $modul->template = "education_news/category.tpl"; //exit;
            }
        }else{
	...
	$modul->template = "education_news/all_news.tpl";
        }
?>
